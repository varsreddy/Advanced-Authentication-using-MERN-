...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-4 text-center bg-gradient-to-r from-blue-400 to-indigo-600 text-transparent bg-clip-text">
        Dashboard
      </h2>

      <div className="space-y-6">
        <motion.div
          className="p-4 bg-gray-800 bg-opacity-50 rounded-lg border
          border-gray-700"
